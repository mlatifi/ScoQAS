...
def obtainConstraintsWhere_Properties_Person_Action(r,s):
...
def obtainConstraintsWhere_GEO(r,s):
    ...
    print "Bounded vars for Where_GEO",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
...
def obtainConstraintsWhere_GEO_TimeRelation(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Where_GEO_TimeRelation",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_GEO')
            if BVars=="tk_GEO" and r.boundedVars['tk_GEO']==values:
...
def obtainConstraintsWhere_TimeRelation(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Where_TimeRelation",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_GEO')
...
def obtainConstraintsWhere_GEO_Member(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Where_GEO_Member",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_GEO')
            if BVars=="tk_GEO" and r.boundedVars['tk_GEO']==values:
                ...
                s._constraints.addNewVariable(r.boundedVars['tk_Memb'])
                s._constraints.addNewConstraint('tk_Memb',[r.boundedVars['tk_Memb'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_PerVar=s._constraints._vars[-1]._var
...
def obtainConstraintsWhere_Properties_Entity(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Where_Properties_Entity",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_GEO')
...
def obtainConstraintsWhere_Properties_GEO_Member(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Where_Properties_GEO_Member",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_GEO')
            if BVars=="tk_GEO" and r.boundedVars['tk_GEO']==values:
...
def obtainConstraintsWhere_Properties_GEO(r,s):
    ...
    print "Bounded vars for Where_Properties_GEO",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_GEO')
            if BVars=="tk_GEO" and r.boundedVars['tk_GEO']==values:
...
def obtainConstraintsWhat_Member(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for What_Properties_Member",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_PER')
            if BVars=="tk_Memb" and r.boundedVars['tk_Memb']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Memb'])
                s._constraints.addNewConstraint('tk_Memb',[r.boundedVars['tk_Memb'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_ActVar=s._constraints._vars[-1]._var
            elif BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
...
def obtainConstraintsWhat_SubType(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())

    print "Bounded vars for What_SubType",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
...
def obtainConstraintsWhat_Properties_Member(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsWhat_Properties(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for What_Person_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_PER')
            if BVars=="tk_Prop" and r.boundedVars['tk_Prop']==values:
...
def obtainConstraintsWhat_Properties_Person_Action(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsWhat_Properties_Action_Entity(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for What_Properties_Action_Entity",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_PER')
            if BVars=="tk_Ent" and r.boundedVars['tk_Ent']==values:
...
def obtainConstraintsWhat_Person_Action_TimeRelation(r,s):
...
def obtainConstraintsWhat_Person_Action(r,s):
...
def obtainConstraintsWho_Member(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Who_Member",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Memb" and r.boundedVars['tk_Memb']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Memb'])
...
def obtainConstraintsWho_Member_CompoundProperties(r,s):
    ...
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Memb" and r.boundedVars['tk_Memb']==values and flagList[1]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_Memb'])
                s._constraints.addNewConstraint('tk_Memb',[r.boundedVars['tk_Memb'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_MembVar=s._constraints._vars[-1]._var
                flagList[1]=1
                ...
                flagList[2]=1
            elif BVars=="tk_Type" and r.boundedVars['tk_Type']==values and flagList[3]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
                s._constraints.addNewConstraint('tk_Type',[r.boundedVars['tk_Type'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_WhoVar=s._constraints._vars[-1]._var
                flagList[3]=1
    ...
    VArg=s._constraints.getVars()
    k=0
    for BVars in r.boundedClassMemb:
        print "BVars,r.boundedClassMemb[BVars]: ",BVars, r.boundedClassMemb[BVars]
        s._constraints.addNewVariable(r.boundedClassMemb[BVars])
        s._constraints.addNewConstraint("class_Memb_" + str(k),[r.boundedClassMemb[BVars],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("ont_Memb_"+ str(k),[ont_MembVar,s._constraints._vars[-1]._var],[ont_MembVar,s._constraints._vars[-1]._var])
        k=k+1

    k=0
    for BVars0,BVars1 in r.boundedSlotMemb:
        VArg=s._constraints.getVars()
        tempSlotMemb0=r.boundedSlotMemb[BVars0,BVars1][0]
        tempSlotMemb1=r.boundedSlotMemb[BVars0,BVars1][1]
        # print "BVars0, BVars1, r.boundedSlotPerson,r.boundedSlotPerson[BVars0,BVars1][0] ",BVars0,BVars1,r.boundedSlotPerson, r.boundedSlotPerson[BVars0,BVars1][0],r.boundedSlotPerson[BVars0,BVars1][1]
        # print "tempSlotPerson0,tempSlotPerson1",tempSlotPerson0,tempSlotPerson1
        chkArg=lookInExistVars(tempSlotMemb0,tempSlotMemb1,VArg)
        AddConstOnt_Slot_MembWith_2_Arg(s,tempSlotMemb0,tempSlotMemb1,chkArg,k)
        k=k+1

    k=0
    for BVars in r.boundedSlotTypeMemb:
        VArg=s._constraints.getVars()
        tempInstMemb0=r.boundedSlotTypeMemb[BVars][0]
        tempInstMemb1=r.boundedSlotTypeMemb[BVars][1]
        tempInstMemb2=r.boundedSlotTypeMemb[BVars][2]
        # print "BVars, r.boundedSlotTypePerson,r.boundedSlotTypePerson[BVars0,BVars1][0] ",BVars,r.boundedSlotTypePerson, r.boundedSlotTypePerson[BVars][0],r.boundedSlotTypePerson[BVars][1]
        # print "tempInstPerson0,tempInstPerson1,tempInstPerson2,r.boundedSlotTypePerson[BVars0,BVars1][1]",tempInstPerson0,tempInstPerson1,tempInstPerson2,r.boundedSlotTypePerson[BVars][2]
        chkArg=lookInExistVars(tempInstMemb0,tempInstMemb1,VArg)
        AddConstOnt_Slot_MembWith_2_Arg(s,tempInstMemb1,tempInstMemb2,chkArg,k)
        k=k+1

    k=0
    for BVars in r.boundedInstanceMemb:
        VArg=s._constraints.getVars()
        tempClsMemb0=r.boundedInstanceMemb[BVars][0]
        tempSlotMemb1=r.boundedInstanceMemb[BVars][1]
        tempInstMemb2=r.boundedInstanceMemb[BVars][2]
        # print "BVars r.boundedInstancePerson,r.boundedInstancePerson[BVars0,BVars1][0] ",BVars,r.boundedInstancePerson, r.boundedInstancePerson[BVars][0],r.boundedInstancePerson[BVars][1],r.boundedInstancePerson[BVars][2]
        # print "tempClsPerson0,tempSlotPerson1,r.boundedInstancePerson[BVars0,BVars1][1]",tempClsPerson0,tempSlotPerson1,r.boundedInstancePerson[BVars][2]
        chkArg=lookInExistVars(tempSlotMemb1,tempInstMemb2,VArg)
        AddConstOnt_Inst_MembWith_2_Arg(s,ont_MembVar,tempClsMemb0,tempSlotMemb1,tempInstMemb2,chkArg,k)
        k=k+1

    k=0
    for BVars in r.boundedClassWho:
        tempClassWho=r.boundedClassWho[BVars]
        s._constraints.addNewVariable(tempClassWho)
        s._constraints.addNewConstraint("EAT_class_" + str(k),[tempClassWho,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
    ...
    for BVars in r.boundedSlotTypeWho:
        tempSlotTypeWho0=r.boundedSlotTypeWho[BVars][0]
        tempSlotTypeWho1=r.boundedSlotTypeWho[BVars][1]
        s._constraints.addNewVariable(tempSlotTypeWho1)
        s._constraints.addNewConstraint("EAT_class_" + str(k),[tempSlotTypeWho1,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("ont_Who_"+ str(k),[ont_WhoVar,s._constraints._vars[-1]._var],[ont_WhoVar,s._constraints._vars[-1]._var])
        k=k+1


    for BVars in r.boundedSubClassWho:
        VArg=s._constraints.getVars()
        tempSubClassSlotTypeWho0=r.boundedSubClassWho[BVars][0]
        tempSubClassSlotTypeWho1=r.boundedSubClassWho[BVars][1]
        # print "BVars, r.Qvar.boundedSubClassWhere_in,r.Qvar.boundedSubClassWhere_in[BVars][0] ",BVars,r.boundedSubClassWhere_in, r.boundedSubClassWhere_in[BVars][0],r.boundedSubClassWhere_in[BVars][1]
        s._constraints.addNewVariable(tempSubClassSlotTypeWho1)
        s._constraints.addNewConstraint("EAT_class_" + str(k),[tempSubClassSlotTypeWho1,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        chkArg=lookInExistVars(tempSubClassSlotTypeWho0,tempSubClassSlotTypeWho1,VArg)
        if chkArg[0]!=-1 and chkArg[1]!=-1:
            # print "boundedSubClassWhere_in in chkArg[0]!=-1 and chkArg[1]!=-1",chkArg[0],chkArg[1]
            s._constraints.addNewConstraint("ont_Subclass_"+ str(k),[chkArg[0],s._constraints._vars[-1]._var],[chkArg[0],s._constraints._vars[-1]._var])
        else:
            print "NOT boundedSubClassWho in chkArg[0]!=-1 and chkArg[1]!=-1",chkArg[0],chkArg[1]

        k=k+1

    i=0
    for BVars in r.boundedInstanceWho:
        VArg=s._constraints.getVars()
        tempClsWho0=r.boundedInstanceWho[BVars][0]
        tempSlotWho1=r.boundedInstanceWho[BVars][1]
        # print "BVars, r.boundedInstanceWhere_in[0],r.boundedInstanceWhere_in[1] ",BVars,r.boundedInstanceWhere_in[BVars][0],r.boundedInstanceWhere_in[BVars][1]
        chkArg=lookInExistVars(tempClsWho0,tempSlotWho1,VArg)
        AddConstOnt_Slot_EATWith_2_Arg(s,tempClsWho0,tempSlotWho1,chkArg,i)
        i=i+1
    ...
    for BVars in r.boundedInstanceWho:
        ...
        tempClsWho0=r.boundedInstanceWho[BVars][0]
        tempSlotWho1=r.boundedInstanceWho[BVars][1]
        tempInsWho2=r.boundedInstanceWho[BVars][2]
        ...
        chkArg=lookInExistVars(tempSlotWho1,tempInsWho2,VArg)
        AddConstOnt_Inst_EATWith_2_Arg(s,ont_WhoVar,tempClsWho0,tempSlotWho1,tempInsWho2,chkArg,i)
        i=i+1


def obtainConstraintsWho_CompoundProperties(r,s):
    ...
    print "Bounded vars for Who_Properties_Person",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
...
def obtainConstraintsWho_CompoundProperties_Person_Action(r,s):
    ...
    boundedClsPerson=sorted(r.boundedClassPerson.values())
    i=0
    print "Bounded vars for Who_CompoundProperties_Person_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_CmpProp" and r.boundedVars['tk_CmpProp']==values and flagList[1]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_CmpProp'])
                s._constraints.addNewConstraint('tk_CmpProp',[r.boundedVars['tk_CmpProp'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_CmpPropVar=s._constraints._vars[-1]._var
                flagList[1]=1
            elif BVars=="tk_ACT" and r.boundedVars['tk_ACT']==values and flagList[2]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_ACT'])
                s._constraints.addNewConstraint('tk_ACT',[r.boundedVars['tk_ACT'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_ActVar=s._constraints._vars[-1]._var
                flagList[2]=1
                ...
                ont_WhoVar=s._constraints._vars[-1]._var
                flagList[3]=1
            elif BVars=="tk_PER" and r.boundedVars['tk_PER']==values and flagList[4]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_PER'])
                s._constraints.addNewConstraint('tk_PER',[r.boundedVars['tk_PER'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_PerVar=s._constraints._vars[-1]._var
                flagList[4]=1
...
def obtainConstraintsWho_CompoundProperties_ORG(r,s):
    ...
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_CmpProp" and r.boundedVars['tk_CmpProp']==values:
                ...
                s._constraints.addNewConstraint('tk_CmpProp',[r.boundedVars['tk_CmpProp'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_PerVar=s._constraints._vars[-1]._var
            elif BVars=="tk_ORG" and r.boundedVars['tk_ORG']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_ORG'])
                s._constraints.addNewConstraint('tk_ORG',[r.boundedVars['tk_ORG'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_PerVar=s._constraints._vars[-1]._var
...
def obtainConstraintsWho_CompoundProperties_Action(r,s):
...
def obtainConstraintsWho_CompoundProperties_GEO(r,s):
...
def obtainConstraintsWho_CompoundProperties_Action_GEO(r,s):
    ...
    print "Bounded vars for Who_CompoundProperties_Action_GEO",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_CmpProp" and r.boundedVars['tk_CmpProp']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_CmpProp'])
...
def obtainConstraintsWho_Action_Ent_Person(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Action_Ent_Person",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
...
def obtainConstraintsWho_Properties_Person(r,s):
...
def obtainConstraintsWho_CompoundProperties_Person(r,s):
...
def obtainConstraintsWhat_Entity_Action(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for What_Entity_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('tk_ENT')
            if BVars=="tk_ENT" and r.boundedVars['tk_ENT']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_ENT'])
                s._constraints.addNewConstraint('tk_ENT',[r.boundedVars['tk_ENT'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_PerVar=s._constraints._vars[-1]._var
...
def obtainConstraintsWho_Action(r,s):
    ...
    print "Bounded vars for Who_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            stripBVars=BVars.strip('ont_PER')
            if BVars=="tk_ACT" and r.boundedVars['tk_ACT']==values:
...
def obtainConstraintsWho_Action_Effect_Person(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Who_Action_Effect_Person",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Efect" and r.boundedVars['tk_Efect']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Efect'])
                s._constraints.addNewConstraint('tk_Efect',[r.boundedVars['tk_Efect'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_PerVar=s._constraints._vars[-1]._var
...
def obtainConstraintsWho_Action_Effect(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Person_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Efect" and r.boundedVars['tk_Efect']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Efect'])
...
def obtainConstraintsHowmuch_Properties_Person(r,s):
    ...
    boundedValues=sorted(r.boundedVars.values())
    boundedClsPerson=sorted(r.boundedClassPerson.values())
    print "Bounded vars for Howmuch_Properties_Person",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_PER" and r.boundedVars['tk_PER']==values and flagList[1]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_PER'])
                s._constraints.addNewConstraint('tk_PER',[r.boundedVars['tk_PER'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_PerVar=s._constraints._vars[-1]._var
                flagList[1]=1
            elif BVars=="tk_Prop" and r.boundedVars['tk_Prop']==values and flagList[2]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_Prop'])
                s._constraints.addNewConstraint('tk_Prop',[r.boundedVars['tk_Prop'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ...
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
                s._constraints.addNewConstraint('tk_Type',[r.boundedVars['tk_Type'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_HowmuchVar=s._constraints._vars[-1]._var
                flagList[3]=1
    ...
    k=0
    for BVars in r.boundedClassHowmuch:
        tempClassHowmuch=r.boundedClassHowmuch[BVars]
        s._constraints.addNewVariable(tempClassHowmuch)
        s._constraints.addNewConstraint("EAT_class_" + str(k),[tempClassHowmuch,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("ont_Howmuch_"+ str(k),[ont_HowmuchVar,s._constraints._vars[-1]._var],[ont_HowmuchVar,s._constraints._vars[-1]._var])
        k=k+1


    for BVars in r.boundedSlotTypeHowmuch:
        tempSlotTypeHowmuch0=r.boundedSlotTypeHowmuch[BVars][0]
        tempSlotTypeHowmuch1=r.boundedSlotTypeHowmuch[BVars][1]
        s._constraints.addNewVariable(tempSlotTypeHowmuch1)
        s._constraints.addNewConstraint("EAT_class_" + str(k),[tempSlotTypeHowmuch1,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("ont_Howmuch_"+ str(k),[ont_HowmuchVar,s._constraints._vars[-1]._var],[ont_HowmuchVar,s._constraints._vars[-1]._var])
        k=k+1

    for BVars in r.boundedSubClassHowmuch:
        VArg=s._constraints.getVars()
        tempSubClassSlotTypeHowmuch0=r.boundedSubClassHowmuch[BVars][0]
        tempSubClassSlotTypeHowmuch1=r.boundedSubClassHowmuch[BVars][1]
        # print "BVars, r.Qvar.boundedSubClassWhere_in,r.Qvar.boundedSubClassWhere_in[BVars][0] ",BVars,r.boundedSubClassWhere_in, r.boundedSubClassWhere_in[BVars][0],r.boundedSubClassWhere_in[BVars][1]
        s._constraints.addNewVariable(tempSubClassSlotTypeHowmuch1)
        s._constraints.addNewConstraint("EAT_class_" + str(k),[tempSubClassSlotTypeHowmuch1,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        chkArg=lookInExistVars(tempSubClassSlotTypeHowmuch0,tempSubClassSlotTypeHowmuch1,VArg)
        if chkArg[0]!=-1 and chkArg[1]!=-1:
            # print "boundedSubClassWhere_in in chkArg[0]!=-1 and chkArg[1]!=-1",chkArg[0],chkArg[1]
            s._constraints.addNewConstraint("ont_Subclass_"+ str(k),[chkArg[0],s._constraints._vars[-1]._var],[chkArg[0],s._constraints._vars[-1]._var])
        else:
    ...
    i=0
    for BVars in r.boundedInstanceHowmuch:
        VArg=s._constraints.getVars()
        tempClsHowmuch0=r.boundedInstanceHowmuch[BVars][0]
        tempSlotHowmuch1=r.boundedInstanceHowmuch[BVars][1]
        # print "BVars, r.boundedInstanceWhere_in[0],r.boundedInstanceWhere_in[1] ",BVars,r.boundedInstanceWhere_in[BVars][0],r.boundedInstanceWhere_in[BVars][1]
        chkArg=lookInExistVars(tempClsHowmuch0,tempSlotHowmuch1,VArg)
        AddConstOnt_Slot_EATWith_2_Arg(s,tempClsHowmuch0,tempSlotHowmuch1,chkArg,i)
        i=i+1
    ...
    for BVars in r.boundedInstanceHowmuch:
        ...
        tempClsHowmuch0=r.boundedInstanceHowmuch[BVars][0]
        tempSlotHowmuch1=r.boundedInstanceHowmuch[BVars][1]
        tempInsHowmuch2=r.boundedInstanceHowmuch[BVars][2]
        # print "BVars, r.boundedInstanceWhere_in[1],r.boundedInstanceWhere_in[2] ",BVars,r.boundedInstanceWhere_in[BVars][1],r.boundedInstanceWhere_in[BVars][2]
        chkArg=lookInExistVars(tempSlotHowmuch1,tempInsHowmuch2,VArg)
        AddConstOnt_Inst_EATWith_2_Arg(s,ont_HowmuchVar,tempClsHowmuch0,tempSlotHowmuch1,tempInsHowmuch2,chkArg,i)
        i=i+1


def obtainConstraintsHowmuch_CompoundProperties(r,s):
    ...
    boundedValues=sorted(r.boundedVars.values())
    boundedClsPerson=sorted(r.boundedClassPerson.values())
    print "Bounded vars for obtainConstraintsHowmuch_CompoundProperties",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values and flagList[1]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_Person_Action(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_Person_Action_Entity(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Person_Action_Entity",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_PER" and r.boundedVars['tk_PER']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_PER'])
...
def obtainConstraintsHowmany_Properties(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Properties",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_Action_GEO_Properties(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Properties_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_Action_Entity_Properties(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Action_Entity_Properties",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_CompoundProperties_Action_Entity(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Action_Entity_PCompoundProperties",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_Entity(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Entity",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_Person_Entity(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_Person_Action_Properties(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_Person(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_Person_Action_CompoundProperties(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_Properties_GEO(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_Person_CompoundProperties_GEO(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_CompoundProperties_GEO",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_CompoundProperties_GEO(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_GEO(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_GEO",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
...
def obtainConstraintsHowmany_Person_GEO(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Person_GEO",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_PER" and r.boundedVars['tk_PER']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_PER'])
...
def obtainConstraintsHowmany_Properties_Action(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsHowmany_Action_GEO(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Action_GEO",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_ACT" and r.boundedVars['tk_ACT']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_ACT'])
...
def obtainConstraintsHowmany_Action(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for Howmany_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_ACT" and r.boundedVars['tk_ACT']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_ACT'])
...
def obtainConstraintsHowmany_Person_CompoundProperties(r,s):
...
def obtainConstraintsWhat_Properties_Action_TimeRelation(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
    ...
    print "Bounded vars for What_Properties_Action",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_ACT" and r.boundedVars['tk_ACT']==values:
                s._constraints.addNewVariable(r.boundedVars['tk_ACT'])
...
def obtainConstraintsWhat_Properties_Action(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def obtainConstraintsWhat_Properties_Entity(r,s):
    ...
    boundedValues=sorted(r.boundedVars.values())
    boundedClsPerson=sorted(r.boundedClassPerson.values())
    print "Bounded vars for What_Properties_Entity",s._text(),"is:", r.boundedVars,boundedValues
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_Type" and r.boundedVars['tk_Type']==values and flagList[1]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_Type'])
                ...
                ont_PropVar=s._constraints._vars[-1]._var
                flagList[2]=1
            elif BVars=="tk_Ent" and r.boundedVars['tk_Ent']==values and flagList[3]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_Ent'])
                s._constraints.addNewConstraint('tk_Ent',[r.boundedVars['tk_Ent'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
    ...
    print "VArg:", VArg
    for vars in VArg:
        depList=addDepList(s,vars._argument)
        lnDepls=len(depList)
        print "vars._argument: lnDepls, depList ",vars._argument, lnDepls,depList
        if lnDepls>0:
            list_Dep.append(depList)

    print "list_Dep:", list_Dep
    i=0
    for lst_dep in range(len(list_Dep)):
        sublist.append(sintDp4Tk(r,s,list_Dep[i]))
        i=i+1
    ...
    #         if len(sub_Temp)>0:
    #             lst_subDep.append(sub_Temp)
    #             print "j, sublst[j], sub_Temp: ",j, sublst[j], sub_Temp
    #             print "i, lst_subDep[i], len(lst_subDep[i]) :  ",i, lst_subDep[i], len(lst_subDep[i])
    #             if len(lst_subDep[i])>0:
    #                 sintDp4Tk(r,s,lst_subDep[i])
    #                 i=i+1
    #         j=j+1
    ...
    VArg=s._constraints.getVars()
    k=0
    for BVars in r.boundedClassEnt:
        print "BVars,r.boundedClassEnt[BVars]: ",BVars, r.boundedClassEnt[BVars]
        s._constraints.addNewVariable(r.boundedClassEnt[BVars])
        s._constraints.addNewConstraint("class_Ent_" + str(k),[r.boundedClassEnt[BVars],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("ont_Ent_"+ str(k),[ont_EntVar,s._constraints._vars[-1]._var],[ont_EntVar,s._constraints._vars[-1]._var])
        k=k+1

    k=0
    for BVars0,BVars1 in r.boundedSlotEnt:
        VArg=s._constraints.getVars()
        tempSlotEnt0=r.boundedSlotEnt[BVars0,BVars1][0]
        tempSlotEnt1=r.boundedSlotEnt[BVars0,BVars1][1]
        chkArg=lookInExistVars(tempSlotEnt0,tempSlotEnt1,VArg)
        AddConstOnt_Slot_EntWith_2_Arg(s,tempSlotEnt0,tempSlotEnt1,chkArg,k)
        k=k+1

    k=0
    for BVars in r.boundedSlotTypeEnt:
        VArg=s._constraints.getVars()
        tempInstEnt0=r.boundedSlotTypeEnt[BVars][0]
        tempInstEnt1=r.boundedSlotTypeEnt[BVars][1]
        chkArg=lookInExistVars(tempInstEnt0,tempInstEnt1,VArg)
        AddConstOnt_Slot_EntWith_2_Arg(s,tempInstEnt0,tempInstEnt1,chkArg,k)
        k=k+1

    k=0
    for BVars in r.boundedInstanceEnt:
        VArg=s._constraints.getVars()
        tempClsEnt0=r.boundedInstanceEnt[BVars][0]
        tempSlotEnt1=r.boundedInstanceEnt[BVars][1]
        tempInstEnt2=r.boundedInstanceEnt[BVars][2]
        # print "BVars r.boundedInstancePerson,r.boundedInstancePerson[BVars0,BVars1][0] ",BVars,r.boundedInstancePerson, r.boundedInstancePerson[BVars][0],r.boundedInstancePerson[BVars][1],r.boundedInstancePerson[BVars][2]
        # print "tempClsPerson0,tempSlotPerson1,r.boundedInstancePerson[BVars0,BVars1][1]",tempClsPerson0,tempSlotPerson1,r.boundedInstancePerson[BVars][2]
        chkArg=lookInExistVars(tempSlotEnt1,tempInstEnt2,VArg)
        AddConstOnt_Inst_EntWith_2_Arg(s,ont_EntVar,tempClsEnt0,tempSlotEnt1,tempInstEnt2,chkArg,k)
        k=k+1
...
def obtainConstraintsWhat_Action_Properties_Status(r,s):
    ...
    for values in boundedValues:
        for BVars in r.boundedVars:
            if BVars=="tk_ACT" and r.boundedVars['tk_ACT']==values and flagList[1]!=1:
                s._constraints.addNewVariable(r.boundedVars['tk_ACT'])
                s._constraints.addNewConstraint('tk_ACT',[r.boundedVars['tk_ACT'],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
                ont_ActVar=s._constraints._vars[-1]._var
                flagList[1]=1
                ...
                ont_WhatVar=s._constraints._vars[-1]._var
                flagList[3]=1
            elif BVars=="tk_Status" and r.boundedVars['tk_Status']==values and flagList[4]!=1:
                ...
                ont_StatusVar=s._constraints._vars[-1]._var
                flagList[4]=1
...
def obtainConstraintsWhat_Properties_Person(r,s):
    list_Dep=[]
    sublist=[]
    lst_subDep=[]
    boundedValues=sorted(r.boundedVars.values())
...
def AddConstOnt_Slot_ActWith_2_Arg(s,ont_SlotAction0,ont_SlotAction1,chkArg,idx):

    if chkArg[0]!=-1 and chkArg[1]==-1:
        print "Slot chkArg[0]!=-1 and chkArg[1]==-1: AddConstOnt_Slot_ActionWith_2_Arg"
        s._constraints.addNewVariable(ont_SlotAction1)
        s._constraints.addNewConstraint("slot_ACT_" + str(idx),[ont_SlotAction1,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("Slot_"+ str(idx),[chkArg[0],s._constraints._vars[-1]._var],[chkArg[0],s._constraints._vars[-1]._var])
...
def AddConstOnt_Slot_PerWith_2_Arg(s,ont_SlotPerson0,ont_SlotPerson1,chkArg,idx):

    if chkArg[0]!=-1 and chkArg[1]==-1:
        print "Slot chkArg[0]!=-1 and chkArg[1]==-1: AddConstOnt_Slot_PerWith_2_Arg"
        s._constraints.addNewVariable(ont_SlotPerson1)
        s._constraints.addNewConstraint("slot_PER_" + str(idx),[ont_SlotPerson1,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("Slot_"+ str(idx),[chkArg[0],s._constraints._vars[-1]._var],[chkArg[0],s._constraints._vars[-1]._var])
...
def AddConstOnt_Inst_ActWith_2_Arg(s,ont_ActVar,ont_ClsAction0,ont_SlotAction1,ont_InstAction2,chkArg,idx):

    if chkArg[0]!=-1 and chkArg[1]==-1:
        print "Inst Action chkArg[0]!=-1 and chkArg[1]==-1"
        s._constraints.addNewVariable(ont_InstAction2)
        s._constraints.addNewConstraint("instance_ACT_" + str(idx),[ont_InstAction2,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("Inst_"+ str(idx),[chkArg[0],s._constraints._vars[-1]._var],[chkArg[0],s._constraints._vars[-1]._var])
...
def AddConstOnt_Inst_PerWith_2_Arg(s,ont_PerVar,ont_ClsPerson0,ont_SlotPerson1,ont_InstPerson2,chkArg,idx):

    if chkArg[0]!=-1 and chkArg[1]==-1:
        print "Inst PER chkArg[0]!=-1 and chkArg[1]==-1"
        s._constraints.addNewVariable(ont_InstPerson2)
        s._constraints.addNewConstraint("instance_PER_" + str(idx),[ont_InstPerson2,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("Inst_"+ str(idx),[chkArg[0],s._constraints._vars[-1]._var],[chkArg[0],s._constraints._vars[-1]._var])
...
def AddConstOnt_Inst_EATWith_2_Arg(s,ont_WrVar,ont_Cls,ont_Slot,ont_Inst,chkArg,idx):

    if chkArg[0]!=-1 and chkArg[1]==-1:
        print "Inst EAT chkArg[0]!=-1 and chkArg[1]==-1"
        s._constraints.addNewVariable(ont_Inst)
        s._constraints.addNewConstraint("EAT_inst_" + str(idx),[ont_Inst,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        s._constraints.addNewConstraint("Inst_"+ str(idx),[chkArg[0],s._constraints._vars[-1]._var],[chkArg[0],s._constraints._vars[-1]._var])

    elif chkArg[0]!=-1 and chkArg[1]!=-1:
        print "Inst EAT chkArg[0]!=-1 and chkArg[1]!=-1",chkArg[0],chkArg[1]
        # s._constraints.addNewVariable(ont_SlotPerson1)
        # s._constraints.addNewConstraint("slot_PER_" + str(idx),[ont_SlotPerson1,s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        # subListG.append(list_Dep[1])
        # s._constraints.addNewConstraint(list_Dep[2],[s._constraints._vars[-1]._var,chkArg[0]],[s._constraints._vars[-1]._var,chkArg[0]])
...
def AddConstWith_2_Arg(s,list_Dep,chkArg,subListG):

    if chkArg[0]!=-1 and chkArg[1]!=-1:
        s._constraints.addNewConstraint(list_Dep[2],[chkArg[1],chkArg[0]],[chkArg[1],chkArg[0]])
    elif chkArg[0]!=-1 and chkArg[1]==-1:
        ...
        s._constraints.addNewConstraint(list_Dep[2],[chkArg[1],s._constraints._vars[-1]._var],[chkArg[1],s._constraints._vars[-1]._var])
    elif chkArg[0]==-1 and chkArg[1]==-1:
        print "chkArg[0]==-1 and chkArg[1]==-1, list_Dep,subListG:  ",list_Dep, subListG
        s._constraints.addNewVariable(list_Dep[0])
        s._constraints.addNewConstraint('tk',[list_Dep[0],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        subListG.append(list_Dep[0])
        constraint_var1=s._constraints._vars[-1]._var
        s._constraints.addNewVariable(list_Dep[1])
        s._constraints.addNewConstraint('tk',[list_Dep[1],s._constraints._vars[-1]._var],s._constraints._vars[-1]._var)
        subListG.append(list_Dep[1])
        s._constraints.addNewConstraint(list_Dep[2],[s._constraints._vars[-1]._var, constraint_var1],[s._constraints._vars[-1]._var,constraint_var1])
